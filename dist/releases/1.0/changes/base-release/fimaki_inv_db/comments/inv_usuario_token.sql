...
-- changeset fimaki_inv_db:1755640727099 stripComments:false  logicalFilePath:base-release/fimaki_inv_db/comments/inv_usuario_token.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot src/database/fimaki_inv_db/comments/inv_usuario_token.sql:null:1dd984dd9098b633eb4e260a623b16fb3dc16945:create

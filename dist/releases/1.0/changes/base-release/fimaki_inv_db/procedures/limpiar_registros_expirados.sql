...
-- changeset FIMAKI_INV_DB:1755640727246 stripComments:false  logicalFilePath:base-release/fimaki_inv_db/procedures/limpiar_registros_expirados.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot src/database/fimaki_inv_db/procedures/limpiar_registros_expirados.sql:null:f9062127aab81fbcaec008be518dd87aa36a238d:create

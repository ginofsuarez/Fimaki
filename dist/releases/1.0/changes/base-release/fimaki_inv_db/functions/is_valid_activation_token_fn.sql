...
-- changeset FIMAKI_INV_DB:1755640727106 stripComments:false  logicalFilePath:base-release/fimaki_inv_db/functions/is_valid_activation_token_fn.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot src/database/fimaki_inv_db/functions/is_valid_activation_token_fn.sql:null:6b104caf8bc70dadea6d04a012b154900c346891:create

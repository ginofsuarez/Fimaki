...
-- changeset fimaki_back_db:1755640725792 stripComments:false  logicalFilePath:base-release/fimaki_back_db/comments/subdivision_geografica.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot src/database/fimaki_back_db/comments/subdivision_geografica.sql:null:2a04cbf0a304037c32278d2cec710371f1ad513b:create

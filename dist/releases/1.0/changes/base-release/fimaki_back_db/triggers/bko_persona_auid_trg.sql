...
-- changeset FIMAKI_BACK_DB:1755640726806 stripComments:false  logicalFilePath:base-release/fimaki_back_db/triggers/bko_persona_auid_trg.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot src/database/fimaki_back_db/triggers/bko_persona_auid_trg.sql:null:ceb9a4a1c3468e225a84ef871d3da51ce9b8e016:create

...
-- changeset FIMAKI_BACK_DB:1755640726902 stripComments:false  logicalFilePath:base-release/fimaki_back_db/triggers/codigo_referencia_auid_trg.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot src/database/fimaki_back_db/triggers/codigo_referencia_auid_trg.sql:null:008080f19015117b1376ad785856d65f6ebe376e:create

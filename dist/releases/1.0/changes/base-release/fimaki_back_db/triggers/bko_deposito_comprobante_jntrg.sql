...
-- changeset FIMAKI_BACK_DB:1755640726722 stripComments:false  logicalFilePath:base-release/fimaki_back_db/triggers/bko_deposito_comprobante_jntrg.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot src/database/fimaki_back_db/triggers/bko_deposito_comprobante_jntrg.sql:null:e04d8aac453c6800064420a876de0becda570ecc:create

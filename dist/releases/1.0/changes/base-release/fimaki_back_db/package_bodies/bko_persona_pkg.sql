...
-- changeset FIMAKI_BACK_DB:1755640725944 stripComments:false  logicalFilePath:base-release/fimaki_back_db/package_bodies/bko_persona_pkg.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot src/database/fimaki_back_db/package_bodies/bko_persona_pkg.sql:null:cef680d5ac66c5f9b0b51ebafb2dcc4fff8f41c5:create

...
-- changeset FIMAKI_BACK_DB:1755640726011 stripComments:false  logicalFilePath:base-release/fimaki_back_db/package_bodies/mail_template_pkg.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot src/database/fimaki_back_db/package_bodies/mail_template_pkg.sql:null:360a91d5da528c801c7ca2cea4fe7a81279f51b4:create

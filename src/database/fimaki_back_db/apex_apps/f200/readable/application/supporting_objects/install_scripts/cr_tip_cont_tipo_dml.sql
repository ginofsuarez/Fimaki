begin
  ...
  using (select 'TIP_CONT' as codigo,
                'TIP_CONT' as nombre,
                'TIP_CONT' as descripcion,
                'S' as sistema_sn,
                'S' as activo_sn
         from dual) y
  ...
  -- === TIP_CONT (referencias con alias) ===
  merge into codigo_referencia x
  using (
    select 'TIP_CONT' as codigo_ref_tipo, 'RESTO' as codigo, 'RESTO' as nombre, '.' as descripcion, 1 as secuencia, 'S' as activo_sn from dual
    union all
    select 'TIP_CONT' as codigo_ref_tipo, 'GRACO' as codigo, 'GRACO' as nombre, '.' as descripcion, 2 as secuencia, 'S' as activo_sn from dual
    union all
    select 'TIP_CONT' as codigo_ref_tipo, 'PRICO' as codigo, 'PRICO' as nombre, '.' as descripcion, 3 as secuencia, 'S' as activo_sn from dual
  ) y
